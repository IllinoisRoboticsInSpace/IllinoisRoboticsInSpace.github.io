			...
			<div ref={ref} className="contactSectionContainer">
				...
				<div className="contactSections">
					...
					<div className="socialContact contactSection">
						...
						<a href="https://www.facebook.com/IllinoisRoboticsInSpace/" className="contactRow">
							Facebook
						</a>
						<a href="https://www.instagram.com/illinoisroboticsinspace/" className="contactRow">
							Instagram
						</a>
						<a href="https://twitter.com/iris_uiuc?lang=en" className="contactRow">
							Twitter
						</a>
