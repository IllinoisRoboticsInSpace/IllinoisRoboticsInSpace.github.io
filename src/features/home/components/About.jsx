    ...
    <LazyLoad>
      <div className="sectionContainer">
        <div className="aboutSection">
          ...
          <p>
            IRIS is an organization that gives students the opportunity to
            design and create innovative robots for{" "}
            <a href="https://www.nasa.gov/offices/education/centers/kennedy/technology/nasarmc.html">
              NASA’s Lunabotics Competition
            </a>
            . We are also very involved with the community, reaching out to
            local schools to encourage STEM for the younger generation. This
            unique experience is rewarding for both our members and the students
            they mentor.
          </p>
        </div>
        <h1> Sponsors </h1>
        ...
        <p>
          Illinois Robotics in Space would like to thank our home department,
          the Department of Aerospace Engineering for their continued support.
        </p>
        <center>
          <img
        ...
        <p>
          ...
          companies willing to support Illinois Robotics in Space as we build
          the best in autonomous and innovative mining robots. Interested in
          ...
          <a href="mailto:iris.uiuc@gmail.com">iris.uiuc@gmail.com</a> if you
          have any questions!
        </p>
      </div>
    </LazyLoad>
